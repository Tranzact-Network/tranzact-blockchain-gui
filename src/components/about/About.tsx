...
import icon from '../../assets/img/tranzact_circle.svg';
...
const url = 'https://tranzact.network';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Tranzact Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Tranzact-Network/tranzact-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
