...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const tranzactper_input = ip_parsed.limit;
    ...
    const tranzactper_value = Number.parseInt(Number(tranzactper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (tranzact per interval):{' '}
                  {mojo_to_tranzact_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
