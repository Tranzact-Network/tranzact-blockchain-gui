...
import { Card, CopyToClipboard, Flex, Table } from '@tranzact/core';
import type { Row } from '../core/components/Table/Table';
import {
  toto_to_tranzact_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? toto_to_colouredcoin_string(row.amount)
        : toto_to_tranzact_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => toto_to_tranzact_string(row.fee_amount),
