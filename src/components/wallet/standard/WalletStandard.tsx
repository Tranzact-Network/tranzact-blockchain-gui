...
import {
  ...
  Fee,
  Form,
  TextField as TranzactTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of tranzact in the blockchain at the current
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send tranzact to coloured address. Please enter a tranzact
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'tranzact_addr://') {
