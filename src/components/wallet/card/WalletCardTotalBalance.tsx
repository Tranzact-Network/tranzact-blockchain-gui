...
import { mojo_to_tranzact_string } from '../../../util/tranzact';
...
export default function WalletCardTotalBalance(props: Props) {
  ...
  return (
    <FarmCard
      ...
      tooltip={
        <Trans>
          This is the total amount of tranzact in the blockchain at the current peak
      ...
      value={
        <>
          {mojo_to_tranzact_string(value)} {currencyCode}
        </>
      }
      description={
