...
import { CardHero, Flex, Link } from '@tranzact/core';
import { PlotHero as PlotHeroIcon } from '@tranzact/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Tranzact. '
              }
              <Link
                target="_blank"
                href="https://github.com/Tranzact-Network/tranzact-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
