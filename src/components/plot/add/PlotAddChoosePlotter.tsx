...
import { CardStep, Select } from '@tranzact/core';
import {
  FormControl,
  FormHelperText,
  Grid,
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Tranzact Proof of Space plotter. If unsure,
            use the default Tranzact Proof of Space plotter.
        </Trans>
      </Typography>
