...
import { AlertDialog, ConfirmDialog } from '@tranzact/core';
        ...
        <DialogContent>
          ...
          {keyring_state.can_save_passphrase && (
            <Box display="flex" alignItems="center">
              ...
              />
              <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Tranzact will be able to access your keys without prompting for your passphrase.`}>
